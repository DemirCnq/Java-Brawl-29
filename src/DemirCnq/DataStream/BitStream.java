...
public class BitStream {
    ...
    public byte[] buffer; // this.add(4);
    private int offset; // this.add(2);
    public int length; // this.add(1);
    ...
    {
        this.WriteBits(intToByteArray(value), bits);
    }
    ...
    public void EnsureCapacity(int capacity)
    {
        ...
        if (this.offset + capacity > bufferLength)
        {
            ...
            System.arraycopy(this.buffer, 0, tmpBuffer, 0, bufferLength);
